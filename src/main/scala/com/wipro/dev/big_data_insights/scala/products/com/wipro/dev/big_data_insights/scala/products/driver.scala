...
private val logger = LoggerFactory.getLogger(getClass.getName)
        ...
        val vdf = spark.read
          ...
          .schema(mdf)
          .option("delimiter", ",")
          .option("header", "true").option("multiline", "true").load("/Users/JO20382899/Downloads/files-main/insight_data/supplier.csv")
        ...
        val cvdf = spark.read
          ...
          .option("delimiter", ",")
          .option("header", "true").option("multiline", "true").load("/Users/JO20382899/Downloads/files-main/insight_data/products_supplier.csv")
